...
public class AccountsDto {
	...
	public void setDrink(Float drink) {
		this.drink = drink;
	}
	...
	public void setCake(Float cake) {
		this.cake = cake;
	}
	...
	public Float getGass() {
		return gass;
	}

	public void setGass(Float gass) {
		this.gass = gass;
	}
	...
	public List<OtherAccounts> getOtherAccountsList() {
